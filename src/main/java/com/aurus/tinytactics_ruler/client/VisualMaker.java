...
public static class VisualMaker {
    ...
    @Environment(EnvType.CLIENT)
    public static void spawnCenterParticle(World world, BlockPos pos, ParticleEffect particle) {
        spawnStaticParticle(world, particle, pos.getX(), pos.getY(), pos.getZ());
    }

    @Environment(EnvType.CLIENT)
    public static void spawnCornerParticles(World world, BlockPos pos, ParticleEffect particle) {
