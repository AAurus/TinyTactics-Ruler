...
public class LineDrawer {
    ...
    public static void renderQuadCrossLine(WorldRenderContext context, Vec3d pos1, Vec3d pos2, int color, double width) {
        List<Vec3d> vecs = createQuadCross(pos1, pos2, width);
        renderQuadsInWorld(context, vecs, color);
    }

    public static void renderQuadCrossLineStrip(WorldRenderContext context, List<Vec3d> positions, int color, double width) {
